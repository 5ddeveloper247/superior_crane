            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add_eventForm">
                        <div class="mb-3">
                            <label for="add_eventTitle" class="form-label">Event Title<span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" id="add_eventTitle" name="add_eventTitle" required>
                            <span class="text-danger" id="title_error"></span>
                        </div>
                        <div class="mb-3">
                            <label for="add_eventDescription" class="form-label">Event Description<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="add_eventDescription"
                                name="add_eventDescription" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="add_status" id="add_status" required>

        ...
        <li class="nav-item pt-2">
          <a href="{{url('transportation')}}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 48 48">
              <g fill="none">
                <rect width="26" height="38" x="5" y="42" stroke="white" stroke-linejoin="bevel" stroke-width="4" rx="2" transform="rotate(-90 5 42)" />
                <path stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M9 16L32 5l5 11" />
                <circle cx="13" cy="23" r="2" fill="white" />
                <circle cx="13" cy="29" r="2" fill="white" />
                <circle cx="13" cy="35" r="2" fill="white" />
                <path stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M21 35h4l11-12m-12 6h6" />
              </g>
            </svg>

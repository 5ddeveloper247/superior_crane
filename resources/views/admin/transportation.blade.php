                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <table id="shipper_table" class="table-responsive w-100">
                                <thead>
                                    <tr>
                                        <th class="px3" scope="col">Name</th>
...
<div class="modal fade" id="shipperDetail_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="shipperDetail_form">
                    <input type="hidden" id="shipper_id" name="shipper_id" value="">
                    <div class="row gy-2 add-form rounded-1 align-items-center">
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="shipper_name">
                                Shipper Name<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="shipper_name" name="shipper_name" type="text"
                                placeholder="Type here..." maxlength="100">
                        </div>
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="form-label fw-semibold" for="shipper_date">
                                Shipper Date<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="shipper_date" name="shipper_date" type="date">
                        </div>

                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="shipper_time_in">
                                Shipper Time-In<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="shipper_time_in" name="shipper_time_in" type="time">
                        </div>
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="shipper_time_out">
                                Shipper Time-Out<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="shipper_time_out" name="shipper_time_out" type="time">
                        </div>
                        ...
                        <div class="col-12 col-md-6 d-flex flex-column">
                            ...
                            <canvas id="shipper_signature" width="450" height="150" style="border: 1px solid #ddd;"></canvas>
                            <div class="d-flex justify-content-end ">
                                <!-- <button class="px-4 rounded-1 py-1 clear-btn" id="clear_signature">Clear</button> -->
                            </div>
                        </div>
...
<div class="modal fade" id="customerDetail_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-6 fw-semibold text-danger" id="">
            ...
            <div class="modal-body">
                <form id="customerDetail_form">
                    <input type="hidden" id="shipper_id" name="shipper_id" value="">
                    <div class="row gy-2 add-form rounded-1 align-items-center">
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="customer_name">
                                Consignee Name<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="customer_name" name="customer_name" type="text"
                                placeholder="Type here..." maxlength="100">
                        </div>
                        
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="form-label fw-semibold" for="customer_date">
                                Consignee Date<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="customer_date" name="customer_date" type="date">
                        </div>

                        <div class="col-12 col-md-12 d-flex flex-column">
                            <label class="fw-semibold form-label" for="customer_email">
                                Consignee Email<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="customer_email" name="customer_email" type="text"
                                placeholder="Type here..." maxlength="100">
                        </div>

                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="customer_time_in">
                                Consignee Time-In<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="customer_time_in" name="customer_time_in" type="time">
                        </div>
                        <div class="col-12 col-md-6 d-flex flex-column">
                            <label class="fw-semibold form-label" for="customer_time_out">
                                Consignee Time-Out<span class="text-danger">*</span>
                            </label>
                            <input class="rounded-1 py-2 px-2 w-100 form-control" id="customer_time_out" name="customer_time_out" type="time">
                        </div>
                        ...
                        <div class="col-12 col-md-6 d-flex flex-column">
                            ...
                            <canvas id="customer_signature" width="450" height="150" style="border: 1px solid #ddd;"></canvas>
                            <div class="d-flex justify-content-end ">
                                <!-- <button class="px-4 rounded-1 py-1 clear-btn" id="clear_signature2">Clear</button> -->
                            </div>
                        </div>

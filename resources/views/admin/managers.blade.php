    ...
    <div class="p-4 mx-1 job-list">
        <div class="row mb-3">
            <div class="col">
                <span>
                    Show
                    <select class="px-2" name="show" id="show">
            ...
            <div class="col text-end">
                ...
                <input class="rounded-1 px-2 py-1" type="search" name="search" id="search">
            </div>
        </div>
            ...
            <table class="table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th style="max-width: 120px" scope="col">Email Address</th>
                        <th style="max-width: 26px; min-width: 84px; width: 23px;" scope="col">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="d-flex gap-2">
                            ...
                            <div class="del">
                                <svg width="15" height="15" viewBox="0 0 9 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
